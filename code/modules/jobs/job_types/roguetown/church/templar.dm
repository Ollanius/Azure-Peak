...
/datum/outfit/job/roguetown/templar/crusader/choose_loadout(mob/living/carbon/human/H)
	...
	switch(weapon_choice)
		if("Longsword")
			...
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/roguetown/armor/chainmail/hauberk, SLOT_ARMOR, TRUE)
		if("Spear")
		...
		if("Crossbow + Shortsword")
			...
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/roguetown/armor/plate/cuirass/silver, SLOT_ARMOR, TRUE) //Cuirass, not halfplate. Slightly reduced starting armor.
		...
		if("Lance of Boils")
			...
			H.put_in_hands(new /obj/item/rogueweapon/scabbard/gwstrap(H))
			H.adjust_skillrank_up_to(/datum/skill/combat/polearms, 4, TRUE)
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/roguetown/armor/chainmail/hauberkr, SLOT_ARMOR, TRUE)
		if("Cleansing Edge")
