...
/datum/outfit/job/roguetown/psydoniantemplar/choose_loadout(mob/living/carbon/human/H)
	...
	switch(armor_choice)
		...
		if("Exorcist - Cuirass, +II INT / +II PER")
			...
			H.equip_to_slot_or_del(new /obj/item/clothing/wrists/roguetown/bracers, SLOT_SHIRT, TRUE)
			H.change_stat(STATKEY_INT, 2)
			H.change_stat(STATKEY_PER, 2)
			H.change_stat(STATKEY_CON, -2)
			H.change_stat(STATKEY_WIL, -2)

	var/weapons = list("Psydonic Longsword", "Psydonic Broadsword", "Psydonic Executioner Sword", "Psydonic War Axe", "Psydonic Whip", "Psydonic Flail", "Psydonic Grand Mace", "Psydonic Halberd + Dagger", "Psydonic Spear + Flanged Mace", "Psydonic Poleaxe + Shortsword", "Psydonic Flanged Mace", "Psydonic Maul")
	...
	switch(weapon_choice)
		...
		if("Psydonic Halberd + Dagger")
			...
			H.equip_to_slot_or_del(new /obj/item/rogueweapon/scabbard/gwstrap(H))
