...
/obj/item/recipe_book/survival/get_mechanics_examine(mob/user)
	...
	. += span_info("In particular, many things will have important details about core mechanics inside of their 'Mechanics' tab. A bed can explain how sleeping works, a tree can explain how climbing works, and so-on.")
