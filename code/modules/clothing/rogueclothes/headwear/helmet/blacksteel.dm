...
/obj/item/clothing/head/roguetown/helmet/blacksteel/modern
	...
	desc = "A magnificent greathelm of blacksteel, bearing the handiwork of Psydonia's finest blacksmiths. Beneath the visor most-assuredly \
	lays a legendary guise; be it a commander's glare, a conquerer's sneer, or a champion's observance."
...
/obj/item/clothing/head/roguetown/helmet/blacksteel
	...
	desc = "An antiquated greathelm of blacksteel, crested with a thick and luscious plume. How much will it take for your faith to \
	sway - and how little will it be? Will you clasp to the atrocities of the past and believe yourself unredeemable, or will you \
	mantle the burden of doing what is right? </br>‎  </br>It is never too late to change; for the better, and for the worse."
	icon_state = "bkhelm"
	item_state = "bkhelm"
