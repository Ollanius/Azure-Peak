...
/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk/paalloy
	...
	desc = "Polished gilbranze rings and silk, woven together to form a sleeved maille-atekon. To bring the lyfeless back from decrepity, to \
	elevate them to heights once thought unsurmountable; that is the will of Zizo, made manifest."
	icon_state = "ancienthauberk"
	smeltresult = /obj/item/ingot/aaslag
...
/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk/aalloy/heavy
	...
	desc = "Frayed bronze rings and rotting leather, woven together to form a sleeved maille-atekon; one that's been uncomfortably tucked \
	beneath a matching cuirass. Such are the last remains of those who've dared to march against the undying legions, be it yils or centuries prior."
...
/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk/paalloy/heavy
	...
	desc = "Polished gilbranze rings and silk, woven together to form a sleeved maille-atekon; one that's been uncomfortably tucked beneath \
	a matching cuirass. It eminates an unfamiliar sensation, rarely seen amongst rot-and-undeath - elegance. In the worlds to come, do you \
	suppose Her death knights would bare such a mantle?"
	icon_state = "ancientcuirasshauberk"
	item_state = "ancientcuirasshauberk"
...
/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk/ornate
	...
	desc = "A beautiful cuirass, decorated with blessed silver fluting and worn atop thick chainmaille. While it falters against \
