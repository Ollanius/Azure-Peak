...
/obj/item/clothing/suit/roguetown/armor/plate/cuirass/legacy
    ...
    desc = "A steel cuirass. Do you still remember the first time you tasted blood; that sanguine \
	succor, dribbling from a busted lip?"
...
/obj/item/clothing/suit/roguetown/armor/plate/legacy
    ...
    desc = "A padded steel cuirass, 'adventurer-fitted' with a pair of pauldrons. Before you is your \
	weapon; when was the last time you had ever thought without its presence?"
...
/obj/item/clothing/suit/roguetown/armor/plate/full/legacy
    ...
    desc = "A complete set of steel plate armor, fitted with tassets and bracers for additional coverage. When \
	the kingdom comes crashing down, will you deliver its people from evil; or will you be the one to string up 'pon the pyre?"
...
/obj/item/clothing/suit/roguetown/armor/plate/full/fluted/legacy
    ...
    desc = "A resplendant set of steel plate armor, decorated with silver flutings. Blessed dreamer, accursed heathen, \
	lowly fool; the curtain call is a mere heartbeat away. Are you ready for one last dance, before midnight calls?"
...
/obj/item/clothing/suit/roguetown/armor/plate/iron
	...
	desc = "A padded iron cuirass, bottomed with segmented tassets. It is inexpensive yet robust; a desirable combination, \
	which has long-since led to its proliferation amongst most of Psydonia's standing garrisons."
...
/obj/item/clothing/suit/roguetown/armor/plate/iron/banded
	...
	desc = "An iron chestplate, pauldrons and tassets worn over a fur vest and padded with heavy leathers. It's \
	primarily worn in the cold north, where armor has to sometimes be cobbled together due to logistical shortages. It \
	leaves the stomach exposed for maneuverability."
...
/obj/item/clothing/suit/roguetown/armor/plate/bronze
	name = "bronze cuirass"
	desc = "A chiseled breastplate of bronze, further padded with hide to comfort its championing bod. The plates \
	have been carefully forged to mimic the statuesque physiques of Psydonia's ancient heroes. Wearing it bolsters \
...
/obj/item/clothing/suit/roguetown/armor/plate/bronze/light
	...
	desc = "A thick bronze plate, meticulously sculpted to fit its wearer's physique and guard their heart from \
	all that'd seek to strike it. Unfortunately, it does little to riposte more emotional blows."
...
/obj/item/clothing/suit/roguetown/armor/plate/aalloy
	...
	desc = "Frayed bronze layers, wrought into plate armor. Once, the hauberk of a rising champion; now, nothing more \
	than a fool's tomb."
...
/obj/item/clothing/suit/roguetown/armor/plate/paalloy
	...
	desc = "Polished gilbronze layers, artificed into plate armor. Let none impede the march of progress, and let Her \
	champions bring the unenlightened masses to kneel."
	icon_state = "ancientplate"
	item_state = "ancientplate"
	smeltresult = /obj/item/ingot/aaslag
...
/obj/item/clothing/suit/roguetown/armor/plate/paalloy/artificer
	...
	desc = "Forbidden knowledge, resurrected into a weightless vessel of gilbranze-and-magicka. It holds a slot for an \
	arcyne meld to power it."
	smeltresult = /obj/item/ingot/aaslag
...
/obj/item/clothing/suit/roguetown/armor/plate/fluted
	...
	desc = "An ornate steel cuirass, fitted with tassets and pauldrons for additional coverage. This \
...
/obj/item/clothing/suit/roguetown/armor/plate/fluted/graggar
	...
	desc = "A fluted vessel of Graggar's hatred, stirring with the same violence that drives our world. Such an inner \
	motive leaves the steel unchained from flesh - enslaved, no more!"
	armor_class = ARMOR_CLASS_MEDIUM
...
/obj/item/clothing/suit/roguetown/armor/plate/full/graggar
	...
	desc = "Shorn together plate, curated from hand-crafted bones and ligaments - combined under an unholy spirit \
	of violence. It drools with the distilled essence of worldlux; the afterbirth of ascensionism."
...
/obj/item/clothing/suit/roguetown/armor/plate/full
	name = "plate armor"
	desc = "A pristine set of steel plate armor, fitted with tassets and bracers for additional coverage. To \
	the Knights of Psydonia, these sets are a symbolic manifestation of their oath; to serve thine kingdom \
	without hesitation, and to rebuke all the villains who'd dare to defile it. </br>‎  </br>'Slow to don-and-doff, without a trusted Squire's aid..'"
	icon_state = "plate"
...
/obj/item/clothing/suit/roguetown/armor/plate/full/samsibsa
	...
	desc = "A heavy set of armour worn by the kouken of distant Kazengun. As opposed to the plate armour utilized \
	by most of Psydonia and the West, samsiba-cheolpan is made of thirty-four rows of composite scales, each an \
	ultra-thin sheet of blacksteel gilded over steel. </br> It is an extremely common practice to engrave characters onto individual plates - such as LUCK, HONOR, or HEAVEN."
...
/obj/item/clothing/suit/roguetown/armor/plate/full/fluted
	name = "fluted plate"
	desc = "A suit of ornate plate armor, noble in both presentation and protection. Such resplendent \
...
/obj/item/clothing/suit/roguetown/armor/plate/full/fluted/ornate
	...
	desc = "A suit of beautiful plate armor, meticulously fluted with blessed silver. This design's origins \
	lay in the hands of a legendary armorsmith, who sought to mimic the heavenly maille that Psydon's angels \
...
/obj/item/clothing/suit/roguetown/armor/plate/fluted/zizo
	...
	desc = "Pauldrons lyke that of fire. The metal curves and curdles with insidious energies, attempting to reform into angularities \
	not meant for the layman's eyes to withstand."
	armor_class = ARMOR_CLASS_MEDIUM
	max_integrity = ARMOR_INT_CHEST_PLATE_STEEL
...
/obj/item/clothing/suit/roguetown/armor/plate/full/zizo
	...
	desc = "Impossible angularities, molded into a form more comprehensible to the layman's eyes. It has been called \
	forth from the edge of what should be known, in Her name."
...
/obj/item/clothing/suit/roguetown/armor/plate/fluted/avantyne
	...
	desc = "Pauldrons lyke that of fire, crested atop a veil of otherworldly maille - impossibly tough, warm to the \
	touch, and crackling with insidious energies."
	armor_class = ARMOR_CLASS_MEDIUM
	max_integrity = ARMOR_INT_CHEST_PLATE_STEEL
	icon_state = "zizoplatechest_med"
...
/obj/item/clothing/suit/roguetown/armor/plate/otavan
	...
	desc = "A gilded steel cuirass, flanked with curved pauldrons and veiled in expensive silks. Like most articles \
	of Otavan armorsmithery, it is both remarkably opulent and protective."
	armor = ARMOR_PLATE
	body_parts_covered = COVERAGE_TORSO
...
/obj/item/clothing/suit/roguetown/armor/plate/cuirass/aalloy
	...
	desc = "Frayed bronze, pounded into a breastplate. It feels more like a corset than a cuirass; there's barely enough \
	width to let those aching lungs breathe."
...
/obj/item/clothing/suit/roguetown/armor/plate/cuirass/fluted
	...
	desc = "An ornate steel cuirass, fitted with tassets for additional coverage. The intricate fluting not only \
	attracts the maidens, but also strengthens the steel's resistance against repeated impacts."
...
/obj/item/clothing/suit/roguetown/armor/plate/cuirass/fluted/gold/heroic
	...
	desc = "A resplendant cuirass of pure gold, fitted with tassets for additional coverage. It has been meticulously \
	waxed-and-assembled from dozens of smaller golden plates, in order to replicate the statuesque physique of Psydonia's legendary heroes."
	unenchantable = TRUE
...
/obj/item/clothing/suit/roguetown/armor/plate/cuirass/copper
	...
	desc = "Shingled copper disks, strapped together to ward the heart from harm. As discovered by its antiquital wearers, it is deceptively \
	protective; yet, its straps can only sustain so much stress before snapping.."
...
/obj/item/clothing/suit/roguetown/armor/plate/silver
	...
	desc = "Noc's holy silver, one fifth. Steel, three fifths. Chosen Material, one fifth. The armor of the Templar, protector and warrior \
	of the Ten's Faithful."
	body_parts_covered = COVERAGE_TORSO
...
/obj/item/clothing/suit/roguetown/armor/plate/scale/marshal
	...
	desc = "A coat of plates concealed beneath a heavy leather surcoat. Only the most battle-hardened of Azuria's commanders \
	can hope to bear its burden, both metaphorically and quite literally."
...
/obj/item/clothing/suit/roguetown/armor/plate/scale/steppe
	...
	desc = "A chestpiece of Aavnic make composed of easily-replaced small rectangular plates of layered steel laced together \
	in rows with wire. Malleable and protective, perfect for cavalrymen."
	icon_state = "hudesutu"
...
/obj/item/clothing/suit/roguetown/armor/plate/scale/inqcoat
	...
	desc = "A heavy longcoat with layers of maille hidden beneath the leather, donned by the Holy Otavan Inquisition's finest. </br>A Psydonic \
	Cuirass can be fitted with this longcoat, in order to ward off deadlier blows without compromising one's fashion sense."
	body_parts_covered = COVERAGE_ALL_BUT_HANDFEET
	allowed_sex = list(MALE, FEMALE)
	allowed_sex = list(MALE, FEMALE)
	icon_state = "inqcoat"
...
/obj/item/clothing/suit/roguetown/armor/plate/scale/inqcoat/armored
	...
	desc = "A heavy longcoat with layers of maille hidden beneath the leather, donned by the Holy Otavan Inquisition's finest. Where the \
	longcoat parts, a surprise awaits; an ornate steel cuirass, worn beneath the leathers to ward off crippling blows."
	smeltresult = /obj/item/ingot/steel 
	icon_state = "inqcoata"
	item_state = "inqcoata"
	equip_delay_self = 4 SECONDS
