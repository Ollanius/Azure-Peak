...
/datum/reagent/medicine/antidote
	name = "Antidote"
	description = "Gradually purges any imbalanced humors and poisons that're present in the bloodstream."
	reagent_state = LIQUID
	color = "#00ff00"
...
/datum/reagent/medicine/strong_antidote
	...
	description = "Rapidly purges any imbalanced humors and poisons that're present in the bloodstream."
	reagent_state = LIQUID
	color = "#004200"
