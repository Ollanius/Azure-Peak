...
/obj/item/obj_destruction(damage_flag)
	...
	if(anvilrepair)
		if(smeltresult == /obj/item/ingot/iron)
			...
			if(prob(20))
				new /obj/item/scrap(get_turf(src))
		if(smeltresult == /obj/item/scrap/zizo)
			new /obj/item/scrap/zizo(get_turf(src))
			if(prob(20))
				new /obj/item/scrap/zizo(get_turf(src))
		if(smeltresult == /obj/item/scrap/graggar)
			new /obj/item/scrap/graggar(get_turf(src))
			if(prob(20))
				new /obj/item/scrap/graggar(get_turf(src))
		if(smeltresult == /obj/item/scrap/matthios)
			new /obj/item/scrap/matthios(get_turf(src))
			if(prob(20))
				new /obj/item/scrap/matthios(get_turf(src))
		if(smeltresult == /obj/item/scrap/baotha)
			new /obj/item/scrap/baotha(get_turf(src))
			if(prob(20))
				new /obj/item/scrap/baotha(get_turf(src))
	if(destroy_sound)
