...
/obj/item/satchel_bomb/mega
	...
	desc = "An overfilled satchel of blastpowder originally made by Lubbin' Bleat, Otava's famed sheep-kin bathhouse \
	attendant and ruler of the slumber beat.. </br>This type of bomb has been banned by all kingdoms and labeled as a \
	threat by both the Churches of the Pantheon and Orthodoxy. IF YOU SEE A LIT WICK, YOU BEST RUN AWAY QUICK!"
	icon_state = "satchel_bomb"
