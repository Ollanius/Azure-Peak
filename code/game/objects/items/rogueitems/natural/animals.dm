...
/obj/item/natural/saddle/get_mechanics_examine(mob/user)
    . = ..()
	. += span_info("Feeding oats or grains to a saiga or fogbeasts allows them to be tamed, and tamed saigas or fogbeasts can be turned into mounts by giving them a saddle.")
