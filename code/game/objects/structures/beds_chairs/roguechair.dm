...
/obj/item/chair/rogue/getonmobprop(tag)
	...
	if(tag)
		switch(tag)
			...
			if("wielded") 
				return list("shrink" = 0.7,"sx" = 9,"sy" = -4,"nx" = -7,"ny" = 1,"wx" = -7,"wy" = 2,"ex" = 8,"ey" = 2,"northabove" = 0,"southabove" = 1,"eastabove" = 1,"westabove" = 0,"nturn" = -42,"sturn" = -80,"wturn" = -170,"eturn" = -10,"nflip" = 4,"sflip" = 4,"wflip" = 1,"eflip" = 0)
