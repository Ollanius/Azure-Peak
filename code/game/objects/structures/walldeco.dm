...
/obj/structure/fluff/walldeco/barbersign/get_mechanics_examine(mob/user)
	...
	. += span_info("Willpower determines how resilient your character is to pain and stress. The higher your Willpower, the more injuries you can withstand before being incapacitated by pain.")
