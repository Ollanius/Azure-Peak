...
/obj/item/enchantingkit/triumph_armorkit_iron
	...
	desc = "A small container of special morphing dust, perfect to make a specific item. It can restore the original appearance of an Iron Breastplate, an Iron Halfplate, or a set of Iron Plate Armo."
	target_items = list(
